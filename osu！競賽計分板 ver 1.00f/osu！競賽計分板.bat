:BAT start
@title µ{¦¡¸ü¤J¤¤...... Now Loading...&echo off&setlocal enableextensions
>nul chcp 950
...
for /f "skip=2 tokens=*" %%a in ('tasklist /fi "imagename eq cmd.exe" /fi "windowtitle eq osu¡IÄvÁÉ­p¤ÀªO ver. %CVer%"') do (
...
:ready
%cls%&color 2f&title osu¡IÄvÁÉ­p¤ÀªO ver. %CVer%
set MG=µ{¦¡¿ï³æ
...
set SN03=ª±®a¥X¥DÃD&set Ex03=¶i¤Jºq¦±¥DÃDªºÀË®Öªí
...
set SN11=¥DÃD¥¢®Ä&set Ex11o=@«Å¥¬¤F¨S¦³¾A·í·j´MÃöÁä¦rªº¥DÃDªº­ì©Ð¥D#³B»@
set SN12=¢Ü¦h¥DÃD&set Ex12o=@«Å¥¬¤F¤@­Ó¥H¤W¥DÃDªº­ì©Ð¥D#³B»@
set SN13=¤½§Gºq¦±¦WºÙ&set Ex13o=@¥Hºq¦±¦WºÙ§@¬°¥DÃDªº­ì©Ð¥D#³B»@
...
set SN25=¿ï¦±¼f§P&set Ex25=¶i¦æ¹ï©Ð¥D©Ò¿ïªººq¦±¬O§_²Å¦X¥DÃDªºªí¨M
...
title osu¡IÄvÁÉ­p¤ÀªO ver. %CVer%
set BMG=
...
:set06
if not "!F04R%R%!!F05R%R%!"=="11" (set MGEx=¿ù»~¡G¦^¦X©|¥¼§¹¦¨&call:mgdiag&goto:ScoreMenu)
